{
  ...
  components: {
    ...
    ambassador: {
      ambassadorImage: 'gcr.io/kubeflow-images-public/quay.io/datawire/ambassador:0.37.0',
    ...
    argo: {
      ...
      executorImage: 'gcr.io/kubeflow-images-public/argoproj/argoexec:v2.2.0',
      name: 'argo',
      uiImage: 'gcr.io/kubeflow-images-public/argoproj/argoui:v2.2.0',
      workflowControllerImage: 'gcr.io/kubeflow-images-public/argoproj/workflow-controller:v2.2.0',
    },
    pipeline: {
      minioPd: 'kf-poc-storage-artifact-store',
      mysqlPd: 'kf-poc-storage-metadata-store',
      name: 'pipeline',
    },
    katib: {
      ...
      vizierDbImage: 'gcr.io/kubeflow-images-public/mysql:8.0.3',
    },
    spartakus: {
      name: 'spartakus',
      reportUsage: 'true',
    ...
    "iap-ingress": {
      ...
      hostname: 'kf-poc.endpoints.goslash-dev.cloud.goog',
