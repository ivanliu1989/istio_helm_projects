{
  ...
  components: {
    ...
    application: {
      components: ['ambassador', 'jupyter', 'notebook-controller', 'jupyter-web-app', 'profiles', 'centraldashboard', 'tf-job-operator', 'pytorch-operator', 'spartakus', 'argo', 'pipeline', 'katib'],
      extendedInfo: 'false',
      name: 'kf-poc',
      type: 'kubeflow',
      version: '0.5',
